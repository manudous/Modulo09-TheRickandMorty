...
var showCharacter = function showCharacter(character) {
  ...
  characterDetail.appendChild(createParagraph("Nickname: " + character.species));
};
  ...
  try {
    var _loop = function _loop() {
      ...
      function characterDetail(id) {
        // console.log(user)
        DataBusiness.getActor(user.id).then(function (user) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "32656" + '/');
